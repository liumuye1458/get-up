...
- `Code X Soundboard-Setup-1.0.0-rc.3-x64.exe`
- `Code X Soundboard-Portable-1.0.0-rc.3-x64.exe`

## RC Fixes In This Build

- Fixed the packaged startup failure caused by a native `better-sqlite3` ABI mismatch in the previous installer build.
- Preserved the phase-one front-end restructure: new stage-style home layout, direct-click cue triggering, and condensed status dock.
